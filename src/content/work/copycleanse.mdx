...
<Screenshot
	src={hero}
	alt="CopyCleanse landing page on a dark theme. Headline: 'Clean AI text, auto-magically' with 'auto-magically' in purple. Subhead: 'Remove hidden characters, smart quotes, tracking URLs, and other telltale signs that expose AI-generated content. Paste below — cleaned text is auto-copied to your clipboard.' Trust pills above the headline ('100% free · No sign-up · Browser-only') and below ('No data stored', 'Works with ChatGPT, Claude, Gemini & more'). A large paste box prompts 'Paste your AI generated text...'."
	caption="copycleanse.com — paste, and the cleaned text is already on your clipboard."
/>
