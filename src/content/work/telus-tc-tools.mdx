...
TC Tools lives alongside [TechCentral](/work/telus-techcentral) as the surface where content creators and operations staff actually do their work — *before* an article goes live, and after, when something has drifted.
...
<Screenshot src={dashboard} alt="TC Tools dashboard listing Creator Tools (Agentic Tools BETA, Search Rank, Image Generator, TC Link Generator, Image Tools, Reference Finder) and Debug Tools (Content Sync, Broken Thumbnails, Broken Link Scanner, Empty Audiences, Content Snapshot, API Diagnostics) inside the TechCentral admin shell." caption="TC Tools dashboard — Creator Tools and Debug Tools under one roof, inside TechCentral." />
...
<Screenshot src={agenticTools} alt="Agentic Tools view inside TC Tools — multi-mode AI content studio for drafting articles from briefs, analyzing copy against the TechCentral rubric, and translating between English and French (Canada) with purpose-built presets." caption="Agentic Tools (BETA) — drafting, rubric analysis, and EN ↔ FR translation in one studio." />
