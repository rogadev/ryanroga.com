...
- **Built to grow.** The architecture made room for the LMS / certification system that became a separate engagement — see [Summit](/work/project-summit-telus).
...
TechCentral is the foundation; the work continues. **Summit** — TELUS's full overhaul of training, mentorship, and certification — runs on top of this platform and is in active development for a 2027 launch. **TC Tools**, an AI-assisted toolkit for content creators inside TechCentral, is shipping in stages.
