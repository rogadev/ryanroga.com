...
The brief is the follow-on engagement to [TechCentral](/work/telus-techcentral). Where TechCentral solved *"where does the operational information live,"* Summit solves *"how do we know — and prove — what each technician is qualified to do."*
