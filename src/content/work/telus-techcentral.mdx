...
The success bar was not "ship a CMS." It was: _replace the patchwork outright, on day one, without giving anyone a reason to fall back to the old bookmarks._
...
<Screenshot
	src={dashboard}
	alt="TechCentral dashboard — bilingual operations and reference platform for TELUS field technicians, with role-aware navigation, search, and content surfaces."
	caption="TechCentral — the daily-driver dashboard for field technicians and contractors."
/>
...
- **Auth and permissions** — iron-session for the cookie layer, a custom permissions endpoint as the source of truth for _who can see what_. Decisions are made server-side and surfaced as visibility rules in the UI.
...
For details on the architecture, the role and permissions model, the bilingual content layer, or what running a production platform of this size actually looks like — [get in touch](/contact/).
