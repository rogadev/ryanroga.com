	...
	<main class="isolate">
					...
					<div class="mx-auto max-w-2xl gap-x-14 lg:mx-0 lg:flex lg:max-w-none lg:items-center">
						<div class="w-full max-w-xl lg:shrink-0 xl:max-w-2xl">
							<h1 class="text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl">
								Junior full-stack web developer in Dartmouth, Nova Scotia.
							</h1>
							<p class="relative mt-6 text-lg leading-8 text-gray-600 sm:max-w-md lg:max-w-none">
								Award winning business owner turned web developer, I bring a unique blend of
								business and technical knowledge to the table. Building micro-SaaS for small
								business is where I thrive and I love integrating AI into projects in new and
								interesting ways.
							</p>
						</div>
						<div
						...
						>
							...
							>
								<div class="relative">
									<!-- TODO rip out all these placeholder images -->
									<img
		...
		<div class="mx-auto -mt-12 max-w-7xl px-6 sm:mt-0 lg:px-8 xl:-mt-8">
			<div class="mx-auto max-w-2xl lg:mx-0 lg:max-w-none">
				<h2 class="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">For hire</h2>
				<div class="mt-6 flex flex-col gap-x-8 gap-y-20 lg:flex-row">
					<div class="lg:w-full lg:max-w-2xl lg:flex-auto">
						<p class="text-xl leading-8 text-gray-600">
							Are you looking for a junior TypeScript or JavaScript developer to grow your team? As
							someone with years of experience in business and web development, I bring a very
							unique set of skills to the table. Have a look at <a
								href="https://github.com/rogadev"
								class=" text-blue-400 cursor-pointer">my projects on GitHub</a
							> to get a sense if I'm right for your team.
						</p>
						<div class="mt-10 max-w-xl text-base leading-7 text-gray-700">
							<p>
								Building something with AI? Several of my projects including my Capstone incorporate
								tools such as the OpenAI API and Vercel AI SDK to bring the power of AI into the
								project in a meaningful way. Suggested projects to check out would include EzTripr,
								my YouTube Chapterizer, and Genny - a simplified question-and-answer chatbot.
							</p>
							<p class="mt-10">
								Are you working with SaaS products for businesses? As someone who has developed web
								tools for my own business, as well as having worked closely with others to help
								develop tools to enhance theirs, I bring a lot of confidence and experience to the
								world of business SaaS. Enhancing, automating, streamlining, and improving business
								operations is absolutely where I thrive.
							</p>
						</div>
					</div>
					<!-- <div class="lg:flex lg:flex-auto lg:justify-center">
						<dl class="w-64 space-y-8 xl:w-80">
							<div class="flex flex-col-reverse gap-y-4">
								<dt class="text-base leading-7 text-gray-600">EzEval Project Evaluation Tool</dt>
								<dd class="text-5xl font-semibold tracking-tight text-gray-900">+30% Close Rate</dd>
							</div>
							<div class="flex flex-col-reverse gap-y-4">
