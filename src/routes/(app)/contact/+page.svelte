		...
		<div class="relative px-6 pb-20 pt-24 sm:pt-32 lg:static lg:px-8 lg:py-48">
			<div class="mx-auto max-w-xl lg:mx-0 lg:max-w-lg">
				...
				>
					...
					>
						<div
							class="aspect-[1155/678] w-[72.1875rem] bg-gradient-to-br from-[#80caff] to-[#6646e5] opacity-20"
				...
				<p class="mt-6 text-lg leading-8 text-gray-300">
					You can reach me by phone or email. I'm always open to new projects, ideas, and
					opportunities.
				</p>
				<dl class="mt-10 space-y-4 text-base leading-7 text-gray-300">
					<div class="flex items-center gap-x-4">
						...
						<dd>Dartmouth, Nova Scotia, Canada</dd>
					</div>
					<div class="flex items-center gap-x-4">
						<dt class="flex-none">
						...
						<dd><a class="hover:text-white" href="tel:+19028308881">+1 (902) 830-8881</a></dd>
					</div>
					<div class="flex items-center gap-x-4">
						<dt class="flex-none">
						...
						<dd>
							<a class="hover:text-white" href="mailto:ryan@roga.dev" target="_blank"
								>ryan@roga.dev</a
							>
						</dd>
					</div>
					...
					<div class="flex items-center gap-x-4">
						<dt class="flex-none">
							...
							<Icon icon="mdi:linkedin" class="h-7 w-6 text-gray-400" />
						</dt>
						<dd>
							<a
								class="hover:text-white"
								href="https://https://www.linkedin.com/in/ryanroga/"
								target="_blank"
					...
					<div class="flex items-center gap-x-4">
						<dt class="flex-none">
							...
							<Icon icon="mdi:github-box" class="h-7 w-6 text-gray-400" />
						</dt>
						<dd>
							<a
								class="hover:text-white"
					...
					<div class="flex items-center gap-x-4">
						<dt class="flex-none">
							...
							<Icon icon="mdi:file-account" class="h-7 w-6 text-gray-400" />
						</dt>
						<dd>
							<a class="hover:text-white italic" href="/resume"> See My Resume... </a>
						</dd>
					</div>
				</dl>
			</div>
