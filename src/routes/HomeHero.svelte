...
<section aria-labelledby="hero-heading" class="relative overflow-hidden">
	...
	<div class="mx-auto max-w-7xl px-6 py-24 sm:py-32 lg:px-8 lg:py-40">
		<div class="mx-auto max-w-2xl text-center">
			<p class="text-sm font-semibold uppercase tracking-widest text-sky-600 mb-4">
			...
			<p class="mt-6 text-lg leading-8 text-gray-600 sm:text-xl text-balance">
				Web apps, SaaS platforms, internal tools, and business websites — scoped, quoted, and
				delivered with clear accountability from day one.
			</p>
			<div class="mt-8 grid grid-cols-1 gap-4 sm:grid-cols-3 sm:gap-6">
				<div class="flex items-center justify-center gap-2 text-sm text-gray-600">
					...
					<span class="whitespace-nowrap">Working software in weeks</span>
				</div>
				<div class="flex items-center justify-center gap-2 text-sm text-gray-600">
					<svg class="h-5 w-5 text-green-500" fill="currentColor" viewBox="0 0 20 20">
						<path
					...
					<span class="whitespace-nowrap">Transparent, fixed pricing</span>
				</div>
				<div class="flex items-center justify-center gap-2 text-sm text-gray-600">
					<svg class="h-5 w-5 text-green-500" fill="currentColor" viewBox="0 0 20 20">
						<path
					...
					<span class="whitespace-nowrap">You own every line of code</span>
				</div>
			</div>
