<section class="relative isolate pt-14">
	...
	>
		...
		<div class="block lg:hidden">
			<h2
				class="text-center mt-16 sm:mt-24 mb-4 text-3xl tracking-tight text-gray-900 font-semibold max-w-md mx-auto"
			>
				<span class="text-5xl font-bold">EzTripr</span><br />Trip tracking for medical companions &
				transport
			</h2>
			<div class="flex justify-center">
				<a
					...
					target="_blank"
					class="text-sm font-semibold leading-6 mb-4 text-gray-900"
					>Learn more <span aria-hidden="true">→</span></a
				>
			</div>
		</div>

		<a href="/projects" class="mt-16 sm:mt-24 lg:mt-0 lg:flex-shrink-0 lg:flex-grow">
			<svg viewBox="0 0 366 729" role="img" class="mx-auto w-[22.875rem] max-w-full drop-shadow-xl">
				<title>EzEval web app screenshot</title>
				<defs>
				...
				>
					<img src="/images/EzTripr Updated Drive UI.png" alt="EzTripr Trip Planner by Ryan Roga" />
				</foreignObject>
			</svg>
		</a>
	</div>
