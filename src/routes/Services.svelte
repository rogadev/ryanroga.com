	...
	<div class="mx-auto max-w-7xl px-6 lg:px-8">
		...
		<div class="mx-auto mt-16 max-w-4xl">
			<div class="rounded-2xl bg-gray-50 p-8">
				<h3 class="text-xl font-semibold text-gray-900 text-center mb-8">Additional Services</h3>
						...
						>
							...
							>
								<path
									stroke-linecap="round"
									stroke-linejoin="round"
									d="M4.5 12a7.5 7.5 0 0015 0m-15 0a7.5 7.5 0 1115 0m-15 0H3m16.5 0H21m-1.5 0H12m-8.457 3.077l1.41-.513m14.095-5.13l1.41-.513M5.106 17.785l1.15-.964m11.49-9.642l1.149-.964M7.501 19.795l.75-1.3m7.5-12.99l.75-1.3m-6.063 16.658l.26-1.477m2.605-14.772l.26-1.477M15.501 4.205l-.75 1.3M8.999 4.205l-.75 1.3M12.751 2.533l-.26 1.477M11.249 2.533l-.26 1.477"
								/>
							</svg>
						</div>
