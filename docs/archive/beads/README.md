...
Migrated from Beads (`bd`) to Claude Code Tasks on **2026-05-20**.

## Summary

- **Total issues**: 5
- **Closed**: 4
- **In-progress** (migrated to Tasks): 1
...
- `issues.jsonl` — full issue export at time of migration
- `interactions.jsonl` — audit trail of status changes

Live tracking moved to Claude Code Tasks. See `~/.claude/tasks/` on a developer machine.
